 ...
 */
 ...
 /**This function will handle site registration */
 function regClients($clientFirstname, $clientLastname, $clientEmail, $clientPassword) {
...
// Function Update Client Information
...
// Function for get the client information.

function getClientInformation($clientId){
    $db = phpmotorsConnect();
    $sql = 'SELECT clientFirstname, clientLastname, clientEmail, clientLevel, clientId, clientPassword FROM clients WHERE clientId = :clientId';
    $stmt = $db->prepare($sql);
