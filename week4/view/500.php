...
<head>
    ...
    <!--STYLE SHEETS-->
    <link href="http://localhost/phpmotors/css/main.css" rel="stylesheet">
    <!--FONTS LINKS-->
...
<body>
    ...
    <main>
        <section>
            <h1>Server Error</h1>
           <p>Sorry our server seems to be experiencing some technical difficulties. Please back later.</p>
        </section>
    </main>
