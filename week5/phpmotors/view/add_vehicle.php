            ...
            <form action="/phpmotors/vehicles/index.php" method="post">
                <fieldset class="login register add">
                  ...
                  <label for="classificationId">Choose a Car:</label>
                    ...
                    <textarea id="invDescription" name="invDescription" placeholder="Add a description"></textarea><br>

                    <label for="invImage">Image Path</label>
                    <input type="text" id="invImage" name="invImage" value="/phpmotors/image/no-image.png"><br>
